...
export const getGetDebriefIncompletedInterviewsResponseMock = (
  overrideResponse: Partial<Extract<ApiResponsePageDashboardDebriefIncompletedInterviewResponse, object>> = {},
): ApiResponsePageDashboardDebriefIncompletedInterviewResponse => ({
  isSuccess: faker.datatype.boolean(),
  code: faker.string.alpha({ length: { min: 10, max: 20 } }),
  message: faker.string.alpha({ length: { min: 10, max: 20 } }),
...
export const getGetDashboardHeadlineResponseMock = (
  overrideResponse: Partial<Extract<ApiResponseDashboardHeadlineResponse, object>> = {},
): ApiResponseDashboardHeadlineResponse => ({
  isSuccess: faker.datatype.boolean(),
  code: faker.string.alpha({ length: { min: 10, max: 20 } }),
  message: faker.string.alpha({ length: { min: 10, max: 20 } }),
  result: faker.helpers.arrayElement([
    {
      ...
      upcomingInterviewDday: faker.helpers.arrayElement([faker.number.int(), undefined]),
    },
    undefined,
  ]),
  ...overrideResponse,
...
export const getGetDashboardCalendarInterviewsResponseMock = (
  overrideResponse: Partial<Extract<ApiResponseListDashboardCalendarResponse, object>> = {},
): ApiResponseListDashboardCalendarResponse => ({
  isSuccess: faker.datatype.boolean(),
  code: faker.string.alpha({ length: { min: 10, max: 20 } }),
  message: faker.string.alpha({ length: { min: 10, max: 20 } }),
