...
export const getGetAllJobCategoriesResponseMock = (
  overrideResponse: Partial<CommonResponseListJobCategoryResponse> = {},
): CommonResponseListJobCategoryResponse => ({
...
export const getGetAllJobCategoriesMockHandler = (
  overrideResponse?:
    ...
    | ((
      ...
      ) => Promise<CommonResponseListJobCategoryResponse> | CommonResponseListJobCategoryResponse),
