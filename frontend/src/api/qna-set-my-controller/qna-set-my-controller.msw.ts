...
export const getSearchMyQnaSetResponseMock = (
  overrideResponse: Partial<CommonResponsePageQnaSetSearchResponse> = {},
): CommonResponsePageQnaSetSearchResponse => ({
...
export const getGetMyFrequentQnaSetCategoriesResponseMock = (
  overrideResponse: Partial<CommonResponsePageFrequentQnaSetCategoryResponse> = {},
): CommonResponsePageFrequentQnaSetCategoryResponse => ({
  isSuccess: faker.helpers.arrayElement([faker.datatype.boolean(), undefined]),
  code: faker.helpers.arrayElement([faker.string.alpha({ length: { min: 10, max: 20 } }), undefined]),
  message: faker.helpers.arrayElement([faker.string.alpha({ length: { min: 10, max: 20 } }), undefined]),
...
export const getGetMyFrequentQnaSetCategoryQuestionsResponseMock = (
  overrideResponse: Partial<CommonResponsePageFrequentQnaSetCategoryQuestionResponse> = {},
): CommonResponsePageFrequentQnaSetCategoryQuestionResponse => ({
  isSuccess: faker.helpers.arrayElement([faker.datatype.boolean(), undefined]),
  code: faker.helpers.arrayElement([faker.string.alpha({ length: { min: 10, max: 20 } }), undefined]),
  message: faker.helpers.arrayElement([faker.string.alpha({ length: { min: 10, max: 20 } }), undefined]),
...
export const getSearchMyQnaSetMockHandler = (
  overrideResponse?:
    ...
    | ((
      ...
      ) => Promise<CommonResponsePageQnaSetSearchResponse> | CommonResponsePageQnaSetSearchResponse),
...
export const getGetMyFrequentQnaSetCategoriesMockHandler = (
  overrideResponse?:
    ...
    | ((
        ...
        | Promise<CommonResponsePageFrequentQnaSetCategoryResponse>
        | CommonResponsePageFrequentQnaSetCategoryResponse),
  options?: RequestHandlerOptions,
) => {
  return http.get(
...
export const getGetMyFrequentQnaSetCategoryQuestionsMockHandler = (
  overrideResponse?:
    ...
    | ((
        ...
        | Promise<CommonResponsePageFrequentQnaSetCategoryQuestionResponse>
        | CommonResponsePageFrequentQnaSetCategoryQuestionResponse),
  options?: RequestHandlerOptions,
) => {
  return http.get(
