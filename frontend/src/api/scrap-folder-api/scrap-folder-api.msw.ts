...
export const getGetMyScrapFoldersResponseMock = (
  overrideResponse: Partial<CommonResponsePageScrapFolderResponse> = {},
): CommonResponsePageScrapFolderResponse => ({
...
export const getGetQnaSetsInScrapFolderResponseMock = (
  overrideResponse: Partial<CommonResponsePageScrapFolderQnaSetResponse> = {},
): CommonResponsePageScrapFolderQnaSetResponse => ({
  isSuccess: faker.helpers.arrayElement([faker.datatype.boolean(), undefined]),
  code: faker.helpers.arrayElement([faker.string.alpha({ length: { min: 10, max: 20 } }), undefined]),
  message: faker.helpers.arrayElement([faker.string.alpha({ length: { min: 10, max: 20 } }), undefined]),
...
export const getGetMyScrapFoldersMockHandler = (
  overrideResponse?:
    ...
    | ((
      ...
      ) => Promise<CommonResponsePageScrapFolderResponse> | CommonResponsePageScrapFolderResponse),
...
export const getGetQnaSetsInScrapFolderMockHandler = (
  overrideResponse?:
    ...
    | ((
        info: Parameters<Parameters<typeof http.get>[1]>[0],
      ) => Promise<CommonResponsePageScrapFolderQnaSetResponse> | CommonResponsePageScrapFolderQnaSetResponse),
  options?: RequestHandlerOptions,
) => {
  return http.get(
