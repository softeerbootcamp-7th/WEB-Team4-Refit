...
export { default as MyCollectionsPage } from './dashboard/_my-collections/page'
export { default as CollectionDetailPage } from './dashboard/_my-collections/detail/page'
