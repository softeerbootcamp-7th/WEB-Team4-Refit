...
public interface InterviewRepository extends JpaRepository<Interview, Long> {
    ...
    """)
    Page<Interview> searchInterviews(User user, String keyword, List<InterviewType> interviewTypes, List<InterviewResultStatus> interviewResultStatuses, LocalDate startDate, LocalDate endDate);
}
