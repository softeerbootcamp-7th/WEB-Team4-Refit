...
public record QnaSetSearchResponse(
        InterviewSimpleDto interviewInfo,
        QnaSetSimpleDto qnaSetSimpleDto
) {
    public static QnaSetSearchResponse from(QnaSet qnaSet) {
        return new QnaSetSearchResponse(
                InterviewSimpleDto.from(qnaSet.getInterview()),
                QnaSetSimpleDto.from(qnaSet)
        );
    }
}
